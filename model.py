...
'''
#This allow to calculate top_k_accuracy
...
model.save_weights('weights_top5.h5')
test_loss,test_acc,top_5_acc = model.evaluate(test_dataset,verbose=1,steps=(len(test_data)//batch_size))
print("[Accuracy: {:5.3f} %".format(100*test_acc)," | ", "loss: {:5.3f}".format(test_loss),']')
print("Top 5 Accuracy: ",top_5_acc)
#model.save_weights('weights_top5.h5')
#model.save('1024_batchNorm.h5')
