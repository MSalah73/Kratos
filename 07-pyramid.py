...
numpyPyramid = []
reduceOne = cv2.pyrDown(numpyInput)
reduceTwo = cv2.pyrDown(reduceOne)
reduceThree = cv2.pyrDown(reduceTwo)
expandThree = cv2.pyrUp(reduceThree)
expandTwo = cv2.pyrUp(reduceTwo)
expandOne = cv2.pyrUp(reduceOne)
numpyPyramid = [numpyInput-expandOne, reduceOne-expandTwo, reduceTwo-expandThree, reduceThree]
